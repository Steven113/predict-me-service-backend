...
public class AppRoutes {
	...
	public static Route userShoppingListFormPage = (req, res) -> {
		...
		//setup map with data to be used for template
    	...
    	//attempt to load data into a HTML template and return it, else return error page
    	try {
	...
	public static Route dataSubmissionPage = (req,res) -> {
		...
		//Generate UserSelectedShoppingItems from URL Query Params
		...
		UserSelectedShoppingItems [] userSelectedShoppingItemsFromDB = userSelectedShoppingItemsFactory.getArrayOfUserSelectedShoppingItemsFromArrayOfDocuments(App.getAllDocumentsFromMongoDBCollection());
		...
		//convert association rules generated by library into AssociationRuleForShoppingItems objects that are more suited for this App
